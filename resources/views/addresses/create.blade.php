...
@section('title', 'Add Address - Fastify')
...
<div class="container mx-auto px-4 py-8 max-w-md bg-white dark:bg-gray-900 min-h-screen">
    ...
    <div class="text-center mb-8">
        ...
        <div class="w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-4">
            <i class="fas fa-map-marker-alt text-3xl text-gray-900 dark:text-white"></i>
        </div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Add New Address</h1>
        <p class="text-gray-600 dark:text-gray-400">Save a new delivery address</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 mb-24">
        <form action="{{ route('addresses.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                >{{ old('additional_instructions') }}</textarea>

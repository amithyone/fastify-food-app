...
@section('title', 'Phone Login - Abuja Eat')
...
<div class="container mx-auto px-4 py-8 max-w-md bg-white dark:bg-gray-900 min-h-screen">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-600 dark:text-gray-400">Login with your phone number</p>
    </div>

    <!-- Phone Login Form -->
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
        <form id="phoneLoginForm" class="space-y-6">
            <!-- Phone Number Input -->
            <div>
    ...
    <div class="mt-6 text-center">
        <p class="text-gray-600 dark:text-gray-400 mb-4">Don't have an account?</p>
        <a href="{{ route('phone.register') }}" class="inline-flex items-center bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 px-6 py-3 rounded-lg font-medium transition duration-200">
    ...
    <!-- Back to Menu -->
    <div class="mt-6 text-center">
        <a href="{{ route('menu.index') }}" class="text-orange-500 dark:text-orange-400 hover:text-orange-600 dark:hover:text-orange-300 text-sm font-medium">

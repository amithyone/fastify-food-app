...
<div class="container mx-auto px-2 py-4 max-w-md bg-white dark:bg-gray-900 min-h-screen">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex items-center gap-2">
            ...
            @endphp
            <a href="{{ $menuUrl }}" class="w-10 h-10 flex items-center justify-center rounded-full bg-orange-100 dark:bg-gray-700 text-orange-500 dark:text-orange-300 transition">
    ...
    @else
        ...
        <div class="text-center py-12 mb-24">
            ...
            <a href="{{ $menuUrl ?? route('menu.index') }}" class="inline-flex items-center bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold transition">
...
<nav class="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 shadow-lg z-50 flex justify-around items-center py-1 px-2 max-w-md mx-auto w-full">
    <a href="{{ $menuUrl ?? route('menu.index') }}" class="flex flex-col items-center text-gray-400 dark:text-gray-400">
        <!-- Home Icon -->
